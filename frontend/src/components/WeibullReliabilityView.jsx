  ...
  return (
    <div className="space-y-6 w-full font-mono">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-8 space-y-4">
          ...
          {weibullData && (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
              <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                ...
                <span className="text-[10px] text-slate-400">90% Survival Bound</span>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                ...
                <span className="text-[10px] text-emerald-400">{weibullData.prognostic_metrics.expected_service_life_years} Service Years</span>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                ...
                <span className="text-[10px] text-slate-400">Arrhenius Rule</span>
              </div>

              <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                <span className="text-slate-500 text-[10px] block uppercase">Combined Multiplier</span>
                <span className="text-xl font-bold text-cyan-300 block font-mono">
                  {weibullData.derating_factors.combined_derating_multiplier}x
                </span>
                <span className="text-[10px] text-slate-400">Net Operational Life</span>
              </div>
            </div>
          )}
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-sm font-bold text-white">Reliability R(t) & Cumulative Failure Probability F(t)</h3>
                <span className="text-xs text-slate-400">Operating Hours vs Probability (%)</span>
              </div>
              <div className="flex gap-3 text-xs">
                <span className="flex items-center gap-1.5 text-emerald-400">
                  <span className="w-3 h-0.5 bg-emerald-400"></span> Reliability R(t)
                </span>
                <span className="flex items-center gap-1.5 text-rose-400">
                  <span className="w-3 h-0.5 bg-rose-400"></span> Failure F(t)
                </span>
              </div>
            </div>
        ...
        <div className="xl:col-span-4 bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-4">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="p-3.5 rounded bg-slate-950 border border-slate-800 text-xs text-slate-300 space-y-1">
              <span className="text-amber-400 font-bold block">Recommended Inspection:</span>
